...
# mount the phone
alias lsphn="simple-mtpfs -l"
alias mphn='function _mount_phone() { simple-mtpfs --device $1 $2; }; _mount_phone'
alias uphn='function _unmount_phone() { fusermount -u $1; }; _unmount_phone'
