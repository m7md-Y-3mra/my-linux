...
int xfps = 120;        // or set to whatever default value you need
int actionfps = 60;    // or set to your preferred value
...
static const char *palettes[][16] = {
    ...
    "#6272a4", "#ff6e6e", "#69ff94", "#ffffa5", "#d6acff", "#ff92d0", "#a4ffff", "#ffffff"},
